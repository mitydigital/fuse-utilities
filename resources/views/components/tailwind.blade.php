...
@if(config('app.env') === 'local')
    <div class="fixed z-50 bottom-0 flex gap-2 left-0 text-center text-white rounded-tr bg-black p-2 text-xs transition-opacity font-mono opacity-50 hover:opacity-100"
